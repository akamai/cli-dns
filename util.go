...
func setHelpTemplates() {
	cli.AppHelpTemplate =
		color.YellowString("Usage: \n") +
			`{{if or (or (eq .HelpName "akamai-dns add-record") (eq .HelpName "akamai dns add-record")) (or (eq .HelpName "akamai-dns rm-record") (eq .HelpName "akamai dns rm-record")) (or (eq .HelpName "akamai-dns retrieve-zone") (eq .HelpName "akamai dns retrieve-zone")) (or (eq .HelpName "akamai-dns update-zone") (eq .HelpName "akamai dns update-zone")) (or (eq .HelpName "akamai-dns list-recordsets") (eq .HelpName "akamai dns list-recordsets")) (or (eq .HelpName "akamai-dns create-recordsets") (eq .HelpName "akamai dns create-recordsets")) (or (eq .HelpName "akamai-dns update-recordsets") (eq .HelpName "akamai dns update-recordsets")) (or (eq .HelpName "akamai-dns retrieve-recordset") (eq .HelpName "akamai dns retrieve-recordset")) (or (eq .HelpName "akamai-dns create-recordset") (eq .HelpName "akamai dns create-recordset")) (or (eq .HelpName "akamai-dns update-recordset") (eq .HelpName "akamai dns update-recordset")) (or (eq .HelpName "akamai-dns delete-recordset") (eq .HelpName "akamai dns delete-recordset")) (or (eq .HelpName "akamai-dns list-zoneconfig") (eq .HelpName "akamai dns list-zoneconfig")) (or (eq .HelpName "akamai-dns create-zoneconfig") (eq .HelpName "akamai dns create-zoneconfig")) (or (eq .HelpName "akamai-dns retrieve-zoneconfig") (eq .HelpName "akamai dns retrieve-zoneconfig")) (or (eq .HelpName "akamai-dns update-zoneconfig") (eq .HelpName "akamai dns update-zoneconfig")) (or (eq .HelpName "akamai-dns submit-bulkzones") (eq .HelpName "akamai dns submit-bulkzones")) (or (eq .HelpName "akamai-dns status-bulkzones") (eq .HelpName "akamai dns status-bulkzones")) (or (eq .HelpName "akamai-dns result-bulkzones") (eq .HelpName "akamai dns result-bulkzones"))}}` +
